...
class EffectPrezuvky : Effect
{
    ...
    protected static Texture2D Sprite = TextureManager.GetTexture("crocs");
    public EffectPrezuvky(int level)
    {
        Name = "Kde je přezutí?";
