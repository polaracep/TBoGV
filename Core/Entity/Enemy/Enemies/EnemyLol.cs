...
internal class EnemyLol : EnemyRanged
{
    ...
    public override List<Projectile> Attack()
    {
        ...
        projectiles.Add(new ProjectilePlatina(Position + Size / 2, Direction, AttackDmg));
        LastAttackElapsed = 0;
        return projectiles;
    }
    ...
    public override void InitStats(int difficulty)
    {
        ...
        MovementSpeed = 2;
        AttackSpeed = 700 - Math.Min(40 * difficulty, 40 * 8);
        AttackDmg = 1;
